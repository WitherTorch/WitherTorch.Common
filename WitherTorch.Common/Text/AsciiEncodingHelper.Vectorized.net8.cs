    ...
    unsafe partial class AsciiEncodingHelper
    {
        private static partial byte* VectorizedReadFromUtf16BufferCore_OutOfAsciiRange(char* source, byte* destination, nuint length)
        {
            ...
            if (Limits.UseVector512() && length >= (nuint)Vector512<byte>.Count)
                VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_512(ref source, ref destination, ref length);
            else if (Limits.UseVector256() && length >= (nuint)Vector256<byte>.Count)
                VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_256(ref source, ref destination, ref length);
            else if (Limits.UseVector128() && length >= (nuint)Vector128<byte>.Count)
                VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_128(ref source, ref destination, ref length);
            else
                VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_64(ref source, ref destination, ref length);
            return result;
        }

        [Inline(InlineBehavior.Remove)]
        private static void VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_512(ref char* source, ref byte* destination, ref nuint length)
        {
            const byte ReplaceCharacter = 0x003F;

            Vector512<ushort> filterVector = Vector512.Create<ushort>(AsciiEncodingLimit);
        ...
        [Inline(InlineBehavior.Remove)]
        private static void VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_256(ref char* source, ref byte* destination, ref nuint length)
        {
            const byte ReplaceCharacter = 0x003F;

            Vector256<ushort> filterVector = Vector256.Create<ushort>(AsciiEncodingLimit);
        ...
        [Inline(InlineBehavior.Remove)]
        private static void VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_128(ref char* source, ref byte* destination, ref nuint length)
        {
            const byte ReplaceCharacter = 0x003F;

            Vector128<ushort> filterVector = Vector128.Create<ushort>(AsciiEncodingLimit);
        ...
        [Inline(InlineBehavior.Remove)]
        private static void VectorizedReadFromUtf16BufferCore_OutOfAsciiRange_64(ref char* source, ref byte* destination, ref nuint length)
        {
            const byte ReplaceCharacter = 0x003F;

            Vector64<ushort> filterVector = Vector64.Create<ushort>(AsciiEncodingLimit);
