...
namespace WitherTorch.Common.Helpers
{
    partial class InterlockedHelper
    {
        ...
        public static partial uint Increment(ref uint location)
            => UnsafeHelper.As<int, uint>(Interlocked.Increment(ref UnsafeHelper.As<uint, int>(ref location)));
        ...
        public static partial ulong Increment(ref ulong location)
            => UnsafeHelper.As<long, ulong>(Interlocked.Increment(ref UnsafeHelper.As<ulong, long>(ref location)));
