...
internal sealed class Condition
{
    internal sealed class Waiter
    {
        public Waiter? next;
        public Waiter? prev;
        public readonly AutoResetEventLite ev = new AutoResetEventLite();
    }
    ...
    // Monitor.Wait (for example, from a SynchronizationContext message pump) gets its own Waiter with a distinct AutoResetEventLite.
    ...
    internal AutoResetEventLite? _waitEvent;
...
#pragma warning disable CS9216 // A value of type 'System.Threading.Lock' converted to a different type will use likely unintended monitor-based locking in 'lock' statement.
        NullSafetyHelper.ThrowIfNull(@lock);
#pragma warning restore CS9216
    ...
    public bool Wait(int millisecondsTimeout, object associatedObjectForMonitorWait)
    {
        ...
        {
            success =
                waiter.ev.Wait(millisecondsTimeout);
        }
        finally
        {
            ...
            else if (!success)
            {
                ...
                // Since WaitOne timed out, it didn't trigger the auto-reset of the AutoResetEventLite.
