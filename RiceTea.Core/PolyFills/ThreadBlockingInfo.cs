...
internal unsafe struct ThreadBlockingInfo
{
    ...
    {
        DebugHelper.ThrowUnless(objectPtr != null);
    ...
    private void Pop()
    {
        DebugHelper.ThrowUnless(_objectPtr != null);
        DebugHelper.ThrowUnless(t_first != null);
        DebugHelper.ThrowUnless(t_first->_next == _next);
